...
function mkQueryHandler(handler: CustomQueryHandler): QueryHandler {
  const internalHandler: QueryHandler = {};
...
const _defaultHandler = mkQueryHandler({
...
export function registerCustomQueryHandler(
  ...
  const internalHandler = mkQueryHandler(handler);
...
export function customQueryHandlerNames(): string[] {
  return Array.from(_queryHandlers.keys());
}
